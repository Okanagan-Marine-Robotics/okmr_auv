...
from okmr_msgs.msg import GoalPose, MovementCommand
...
def handle_bbl_dvl(goal_handle):
    ...
    try:
        dvl_sub = node.create_subscription(Dvl, '/dvl', lambda msg: '_dvl_callback', 10)
...
def _send_velocity():
    ...
    msg.goal_velocity.twist.linear.z = 0.1
